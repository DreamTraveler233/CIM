...
namespace CIM::http
{
    ...
    void HttpRequestParser::setError(int v) { m_error = v; }
    ...
    HttpRequest::ptr HttpRequestParser::getData() const { return m_data; }
    ...
    HttpResponse::ptr HttpResponseParser::getData() const { return m_data; }

    void HttpResponseParser::setError(int v) { m_error = v; }
