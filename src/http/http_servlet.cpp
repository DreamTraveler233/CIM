...
namespace CIM::http
{
    ...
    const std::string &Servlet::getName() const { return m_name; }
    Servlet::ptr ServletDispatch::getDefault() const { return m_default; }
    void ServletDispatch::setDefault(Servlet::ptr v) { m_default = v; }
}