#ifndef __CIM_DS_HASH_MULTIMAP_HPP__
#define __CIM_DS_HASH_MULTIMAP_HPP__
...
namespace CIM::ds
{
    ...
    public:
        ...
        bool insert(const K &k, const V *v, const uint32_t &size)
        {
            ...
            else
            {
                ...
                it->val = datas;
                Atomic::addFetch(m_elements, news.size());
            }
            return true;
        }
        ...
        bool del(const K &k)
        {
            ...
            else
            {
                ...
                Atomic::subFetch(m_elements, (uint64_t)it->size);
    ...
    RWMutex HashMultimap<K, V, PosHash>::s_mutex[MAX_MUTEX];
