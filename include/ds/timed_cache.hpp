...
namespace CIM::ds
{
    ...
    public:
        ...
        void set(const K &k, const V &v, uint64_t expired)
        {
            ...
            auto sit = m_timed.insert(Item(k, v, expired + GetCurrentMS()));
    ...
    template <class K, class V, class RWMutexType = RWMutex, class Hash = std::hash<K>>
